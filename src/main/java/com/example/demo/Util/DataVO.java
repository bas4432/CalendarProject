...
public class DataVO {
	...
	// 날짜에 관련된 달력정보를 가지는 메서드
		public Map<String, Integer> today_info(DataVO datavo) {
			// 날짜 캘린더 함수에 삽입.
			Map<String, Integer> today_Data = new HashMap<String, Integer>();
			Calendar cal = Calendar.getInstance();
			cal.set(Integer.parseInt(datavo.getYear()), Integer.parseInt(datavo.getMonth()), 1);
			...
			int search_year = Integer.parseInt(datavo.getYear());
			int search_month = Integer.parseInt(datavo.getMonth()) + 1;
		...
		// 달력만 사용시 사용될 생성자
		public DataVO(String year, String month, String date, String value) {
